...
- **AI 출력**: 1·3회차는 급변 #45, #63, #34만 보고. 2회차는 치우침 #53–59(7점)와 #68–70(3점)을 더 보고.
- **무엇이 틀렸나**: 1·3회차는 치우침과 추세를 모두 놓쳤다. #63(97.45nm)과 #34(97.79nm)는 LCL 97nm 안쪽이라 급변이 아니다. 2회차의 치우침은 규칙(연속 9점 이상)보다 짧은 구간이다. 채점은 구간 겹침이라 2회차 #53–59는 '탐지'로 셌지만, 규칙 정의는 맞추지 못했다.
